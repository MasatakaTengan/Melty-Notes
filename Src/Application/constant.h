...
namespace Constant
{
	...
	static const int PERFECT_RANGE = BMS_RESOLUTION / 16;		// PERFECTと判定する中心からの範囲(前後合わせて24分音符内)
	...
	static const int MISS_RANGE = BMS_RESOLUTION / 2;		// POOR判定する中心からの範囲(前後合わせて1小節内)
